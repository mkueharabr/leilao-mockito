...
class GeradorDePagamentoTest {
	...
	// utilizar o captor para capturar um objeto que foi gerada dentro do método
	@Captor
	...
	void deveriaCriarPagamentoParaVencedorLeilao() {
		...
		LocalDate data = LocalDate.of(2021, 05, 07);
		...
		// pega o paramento passado no método salvar do pagamentoDao
